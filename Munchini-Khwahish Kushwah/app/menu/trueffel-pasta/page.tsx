...
export default function TrueffelPastaPage() {
  ...
  const totalPrice =
    18.99 * quantity +
    (selections["Trüffel-Intensität"] === "Extra" ? 2 : 0) +
    (selections["Protein hinzufügen"] !== "Keins" ? 3 : 0)
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm sticky top-0 z-10 p-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <h1 className="text-2xl font-bold">Trüffel-Pasta</h1>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
          ...
          <div className="p-4">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-2xl font-bold">Trüffel-Pasta</h2>
            </div>
            <p className="text-gray-600 mb-4">
              Köstliche Pasta mit reichhaltiger Trüffelcreme-Sauce, frischen Kräutern und Parmesankäse.
            </p>
