...
const customizationOptions = [
  { name: "Füllung", options: ["Klassisch", "Tofu", "Pilze"] },
  { name: "Sauce", options: ["Süß-Sauer", "Erdnuss", "Chili"] },
  { name: "Extra", options: ["Mehr Gemüse", "Knuspriger", "Sesam"] },
]
...
export default function VeganeFruehlingsrollenPage() {
  ...
  const totalPrice = 7.99 * quantity + selections["Extra"].length * 1
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm sticky top-0 z-10 p-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <h1 className="text-2xl font-bold">Vegane Frühlingsrollen</h1>
      ...
      <main className="max-w-4xl mx-auto p-4">
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
          <div className="relative h-64 sm:h-80">
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/shan-shi-rezepte-vegane-fruehlingsrollen.jpg-IlnXbJXwCjqkQ3MZOzepAmQ9kQ4AZH.jpeg"
              alt="Vegane Frühlingsrollen"
              layout="fill"
              objectFit="cover"
            />
          </div>
          <div className="p-4">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-2xl font-bold">Vegane Frühlingsrollen</h2>
            ...
            <p className="text-gray-600 mb-4">
              Knusprige Frühlingsrollen gefüllt mit frischem Gemüse und Tofu, serviert mit einer süß-sauren Sauce.
            </p>
